...
export const NewsList: React.FC<NewsListProps> = ({
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No News Available</h3>
          <p className="text-gray-500 dark:text-gray-400">There are no news articles available at the moment.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={compact ? 'space-y-0 divide-y divide-gray-200 dark:divide-gray-700' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'}>
        {news.map((article) => (
          <NewsCard 
            key={article.uuid} 
            news={article} 
