...
const DeleteUserModal: React.FC<DeleteUserModalProps> = ({
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      const endpoint = deleteData.deleteType === 'hard' 
      ...
      const deleteTypeText = deleteData.deleteType === 'hard' ? 'permanently deleted' : 'deactivated'
  ...
  return (
    <Modal 
      isOpen={isOpen} 
      onClose={handleClose} 
      title={`Delete User: ${getUserDisplayName()}`}
    >
      <div className="max-w-lg">
        {confirmationStep === 1 ? (
          <div className="space-y-6">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-sm text-yellow-700 dark:text-yellow-300">
                    You are about to delete user: <strong>{getUserDisplayName()}</strong> ({user.email})
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getSeverityColor('soft')}`}>
                          Reversible
                        </span>
                      </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getSeverityColor('hard')}`}>
                          Irreversible
                        </span>
                      </div>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                Type user's email to confirm: <code className="text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">{user.email}</code>
              </label>
              <input
                type="email"
          ...
          <div className="space-y-6">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-sm text-red-700 dark:text-red-300">
                    This action will {deleteData.deleteType === 'hard' ? 'permanently delete' : 'deactivate'} the user and cannot be undone.
                  </p>
                </div>
              </div>
            </div>
              ...
              <dl className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="text-sm font-medium">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getSeverityColor(deleteData.deleteType)}`}>
            ...
            {/* Action Buttons */}
            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
              <Button onClick={() => setConfirmationStep(1)} variant="secondary" disabled={deleting}>
                Back
              </Button>
              ...
              >
                {deleting ? 'Processing...' : `Confirm ${deleteData.deleteType === 'hard' ? 'Permanent' : 'Soft'} Delete`}
              </Button>
            </div>
          </div>
        )}
