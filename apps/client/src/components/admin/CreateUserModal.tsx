        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="generatePassword" className="ml-2 block text-sm text-gray-900 dark:text-gray-100">
        ...
        <div>
          ...
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
            />
            <label htmlFor="sendWelcomeEmail" className="ml-2 block text-sm text-gray-900 dark:text-gray-100">
