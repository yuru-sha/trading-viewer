      ...
      <div className='p-4 border-b border-gray-200 dark:border-gray-700'>
        <div className='flex items-center justify-between mb-4'>
          <div>
            ...
            {simulation && (
              <p className='text-sm text-gray-600 dark:text-gray-400'>
                {simulation.name} • {simulation.status === 'active' ? '🟢 Active' : '⏸️ Paused'}
              </p>
            )}
          </div>
          ...
          <div className='flex items-center space-x-2'>
            {!simulation ? (
              <Button variant='primary' size='sm' onClick={() => setShowCreateSimModal(true)}>
                Create Simulation
              </Button>
            ) : (
              <div className='flex items-center space-x-2'>
        ...
        {!simulation && activeTab !== 'settings' ? (
          <div className='text-center py-12'>
            <div className='space-y-4'>
              ...
              <Button variant='primary' onClick={() => setShowCreateSimModal(true)}>
                    ...
                    <div className='space-y-4'>
                      <div className='grid grid-cols-2 gap-4 text-sm'>
                        ...
                        <div>
                          ...
                          <span className='ml-2 font-medium text-gray-900 dark:text-white'>
                            {formatCurrency(simulation.portfolio.initialBalance)}
                          </span>
                        </div>
                        <div>
                          ...
                          <span className='ml-2 font-medium text-gray-900 dark:text-white'>
                            ...
                            {formatPercent(simulation.settings.commissionPercentage)}
                          </span>
                        </div>
                      </div>
