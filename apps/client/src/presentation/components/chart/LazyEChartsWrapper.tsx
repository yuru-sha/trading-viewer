...
import type { EChartsTradingChartProps } from '@/presentation/components/chart/EChartsTradingChart'

// Export types explicitly to resolve TS4023
export type { EChartsTradingChartRef, EChartsTradingChartProps }
