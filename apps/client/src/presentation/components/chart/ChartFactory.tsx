...
} from '@/presentation/components/OptimizedChartContainer'
import { LazyEChartsTradingChart } from '@/presentation/components/chart/LazyEChartsWrapper'
  ...
  render(): JSX.Element {
    return (
      <OptimizedChartContainer
        ...
        showDrawingTools={Boolean(this.config.drawingTools?.length)}
