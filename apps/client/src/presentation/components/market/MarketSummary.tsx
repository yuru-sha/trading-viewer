...
// import { api } from '@/infrastructure/adapters/apiClient' // TODO: Re-enable when rankings API is implemented
import { MiniChart } from '@/presentation/components/MiniChart'
...
export const MarketSummary: React.FC<MarketSummaryProps> = ({
  ...
  const [gainers] = useState<RankingItem[]>([])
  const [losers] = useState<RankingItem[]>([])
  const [mostActive] = useState<RankingItem[]>([])
  const [trending] = useState<RankingItem[]>([])
  ...
  useEffect(() => {
    const fetchRankingData = async () => {
      try {
        ...
        // TODO: Implement rankings API endpoints
        ...
        // TODO: Set data when rankings API is implemented
  ...
  useEffect(() => {
    const fetchIndicesData = async () => {
      try {
        ...
        // TODO: Implement getIndices API endpoint
