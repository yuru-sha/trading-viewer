...
import { useCandlestickSeries } from '@/presentation/hooks/chart-types/useCandlestickSeries'
import { useLineSeries } from '@/presentation/hooks/chart-types/useLineSeries'
import { useAreaSeries } from '@/presentation/hooks/chart-types/useAreaSeries'
import { useChartLayout } from '@/presentation/hooks/layout/useChartLayout'
import { calculateIndicatorFromData } from '@/infrastructure/utils/calculations/indicatorProcessor'
