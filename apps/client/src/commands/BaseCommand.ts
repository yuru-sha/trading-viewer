 ...
 */
export abstract class BaseCommand<TResult = any, TParams = any> implements ICommand<TResult, TParams> {
  readonly id: string
  ...
  clone(newParams?: Partial<TParams>): BaseCommand<TResult, TParams> {
    const CommandClass = this.constructor as new (type: string, params: TParams, canUndo: boolean) => BaseCommand<TResult, TParams>
