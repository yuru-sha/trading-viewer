...
import type { DrawingObject } from '../ui/drawing'
...
export interface DrawingCommandParams {
  type: string
  data: Partial<DrawingObject>
  position?: { x: number; y: number }
}

export interface CreateDrawingCommand extends ICommand<DrawingObject> {
  params: DrawingCommandParams
}

export interface UpdateDrawingCommand extends ICommand<DrawingObject> {
  drawingId: string
  updates: Partial<DrawingObject>
}

export interface DeleteDrawingCommand extends ICommand<boolean> {
  drawingId: string
}
