...
INSERT INTO "new_drawing_tools" ("created_at", "id", "locked", "points", "style", "symbol", "text", "type", "updated_at", "user_id", "visible") SELECT "created_at", "id", "locked", "points", "style", "symbol", "text", "type", "updated_at", "user_id", "visible" FROM "drawing_tools";
